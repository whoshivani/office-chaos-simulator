...
export default function App() {
  ...
  const [username, setUsername] = useState('unpaid intern');
  ...
  const handleStartOver = () => {
    ...
    localStorage.removeItem('office_username');
    ...
    localStorage.removeItem('office_stat_total_score');
    ...
    // 3. Stay on the Menu screen so they can see everything reset to zero and customize their name!
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-start md:justify-center p-4 py-6 md:py-12 select-none relative text-slate-100 overflow-y-auto overflow-x-hidden font-sans">
